...
// Listas oficiales de géneros de TMDb
const MOVIE_GENRES = [
  { id: 28, name: "Acción" },
  { id: 12, name: "Aventura" },
    ...
    <div className="bg-neutral-900 border border-neutral-800 p-4 rounded-xl shadow-lg mb-8 text-neutral-100 flex flex-col gap-4">
      ...
      <div className="relative">
        ...
        {query && (
          <button
            onClick={clearSearch}
            className="absolute right-3 top-2.5 text-neutral-400 hover:text-white p-0.5 rounded-full hover:bg-neutral-700 transition-colors"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => {
              ...
              setType(newType);
              setGenre(""); // Reinicia género al cambiar de película a serie
        ...
        {/* Género (con opción "Todos" por defecto) */}
        <div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              onKeyDown={(e) => e.key === "Enter" && updateFilters({ year })}
